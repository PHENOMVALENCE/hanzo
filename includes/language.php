...
function hanzo_phrase_maps(): array
{
    return [
        'sw' => [
            ...
            'China Chapu verified partner' => 'Mshirika aliyethibitishwa na China Chapu',
            'Manage catalog, fulfil assigned orders, and post production milestones through China Chapu.' => 'Simamia katalogi, timiza maagizo uliyopewa, na chapisha hatua za uzalishaji kupitia China Chapu.',
        ...
        'zh' => [
            ...
            'China Chapu verified partner' => 'China Chapu 认证合作伙伴',
            'Manage catalog, fulfil assigned orders, and post production milestones through China Chapu.' => '通过 China Chapu 管理目录、处理分配订单并发布生产里程碑。',
            'Active SKUs' => '在售 SKU',
