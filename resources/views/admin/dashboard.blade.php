...
@php
  ...
  $productsAwaitingReview = Product::where('status', Product::STATUS_PENDING)->count();
  ...
  foreach (Product::where('status', Product::STATUS_PENDING)->latest()->take(2)->get() as $p) {
...
<div class="row mb-4">
  <div class="col-12">
    ...
    <p class="text-muted mb-0 opacity-75">{{ __('admin.dashboard.subtitle') }}</p>
  </div>
</div>

{{-- Platform-wide KPIs --}}
<p class="text-uppercase small fw-semibold text-muted mb-2" style="letter-spacing: 0.08em;">Platform Overview</p>
...
<p class="text-uppercase small fw-semibold text-muted mb-2" style="letter-spacing: 0.08em;">Activity & Actions</p>
<div class="row g-4 mb-5">
  {{-- Live activity feed --}}
  <div class="col-xl-5 mb-4 mb-xl-0">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('admin.dashboard.live_activity') }}</h5>
  ...
  <div class="col-xl-4 mb-4 mb-xl-0">
    <div class="card h-100">
      <div class="card-header">
        <h5 class="mb-0">{{ __('admin.dashboard.action_queue') }}</h5>
      </div>
      <div class="card-body">
        ...
        <a href="{{ route('admin.dashboard') }}#products" class="hanzo-admin-alert alert-warning text-decoration-none d-block">
  ...
  <div class="col-xl-3">
    <div class="card h-100">
      <div class="card-header">
        <h5 class="mb-0">{{ __('admin.dashboard.revenue_snapshot') }}</h5>
      </div>
      <div class="card-body">
...
<p class="text-uppercase small fw-semibold text-muted mb-2" style="letter-spacing: 0.08em;">Geographic Distribution</p>
<div class="row">
  <div class="col-12 mb-4">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('admin.dashboard.map_distribution') }}</h5>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  var revenueConfig = {
    ...
    dataLabels: { enabled: true, formatter: function(v) { return v > 0 ? v.toFixed(0) : ''; } },
    series: [{ name: '{{ __("admin.dashboard.hanzo_margin_revenue") }}', data: [{{ $revenueThisWeek }}, {{ $revenueLastWeek }}, {{ $hanzoMarginThisMonth }}, {{ $hanzoMarginLastMonth }}] }],
    xaxis: { categories: ['{{ __("admin.dashboard.this_period") }} (w)', '{{ __("admin.dashboard.last_period") }} (w)', '{{ __("admin.dashboard.this_period") }} (m)', '{{ __("admin.dashboard.last_period") }} (m)'], labels: { style: { colors: '#94a3b8' } } },
