    ...
    <div class="row g-4 text-center">
      <div class="col-md-6 col-lg-3">
        <div class="hanzo-card p-4 h-100">
          <i class="bx bx-file bx-lg mb-3" style="color: var(--hanzo-amber);"></i>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="hanzo-card p-4 h-100">
          <i class="bx bx-message-detail bx-lg mb-3" style="color: var(--hanzo-amber);"></i>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="hanzo-card p-4 h-100">
          <i class="bx bx-factory bx-lg mb-3" style="color: var(--hanzo-amber);"></i>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="hanzo-card p-4 h-100">
          <i class="bx bx-truck bx-lg mb-3" style="color: var(--hanzo-amber);"></i>
