...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            :root { --hanzo-navy: #141B2D; --hanzo-gold: #D4AF37; --hanzo-gold-alt: #FFAB00; --hanzo-slate: #F5F7FA; }
            ...
            .btn-hanzo { background: var(--hanzo-gold-alt); color: var(--hanzo-navy); border: none; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; }
            .btn-hanzo:hover { background: #e69c00; color: var(--hanzo-navy); }
